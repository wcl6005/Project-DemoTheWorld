...
![example image](http://www.unexpected-vortices.com/sw/rippledoc/example-image.jpg "An exemplary image")
    ...
    for i in range(5):
        category = Category(name='Category {0}'.format(i),
                            image='https://raw.githubusercontent.com/wu-wenxiang/Media-WebLink/master/qiniu/Test-f4f338218d4245cf8fad114381f0e30a-CloudTools.png',
        ...
        for j in range(12):
            ...
            for k in range(1, 9):
                chapter = Chapter(course_id=course.id,
                                  ...
                                  video_url='https://raw.githubusercontent.com/wu-wenxiang/Media-WebLink/master/qiniu/Test-f4f338218d4245cf8fad114381f0e30a-sport.mp4',
